...
public class ModTrimPatterns extends TrimPatterns {
    ...
    public static void register(BootstrapContext<TrimPattern> context, DeferredItem<Item> item, ResourceKey<TrimPattern> key) { TrimPattern trimpattern = new TrimPattern(
            key.location(),
            item.getDelegate(),
